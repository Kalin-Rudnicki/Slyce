      ...
      .build { builder =>
        ...
        lazy val s9: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_3: NonTerminal.Expr)) :: elem(-\/(_2: Token.powOp)) :: stateElem(
                      state,
                      \/-(_1: NonTerminal.Expr_2),
                    ) :: stackT =>
                  (
        ...
        lazy val s14: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_3: NonTerminal.Expr_3)) :: elem(-\/(_2: Token.multOp)) :: stateElem(
                      state,
                      \/-(_1: NonTerminal.Expr_2),
                    ) :: stackT =>
                  (
        ...
        lazy val s16: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_3: NonTerminal.Expr_4)) :: elem(-\/(_2: Token.addOp)) :: stateElem(
                      state,
                      \/-(_1: NonTerminal.Expr_3),
                    ) :: stackT =>
                  (
        ...
        lazy val s19: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(-\/(_3: Token.__.`)`)) :: elem(\/-(_2: NonTerminal.Expr)) :: stateElem(
                      state,
                      -\/(_1: Token.__.`(`),
                    ) :: stackT =>
                  (
        ...
        lazy val s22: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_3: NonTerminal.Lines_2)) :: elem(\/-(_2: NonTerminal.Line)) :: stateElem(
                      state,
                      \/-(_1: NonTerminal.AnonList1),
                    ) :: stackT =>
                  (
        ...
        lazy val s30: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_4: NonTerminal.Lines_2)) :: elem(\/-(_3: NonTerminal.AnonList1)) :: elem(
                      \/-(_2: NonTerminal.Line),
                    ) :: stateElem(state, \/-(_1: NonTerminal.AnonList1)) :: stackT =>
                  (
                    state,
        ...
        lazy val s31: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_3: NonTerminal.Expr)) :: elem(-\/(_2: Token.__.`=`)) :: stateElem(
                      state,
                      -\/(_1: Token._var),
                    ) :: stackT =>
                  (

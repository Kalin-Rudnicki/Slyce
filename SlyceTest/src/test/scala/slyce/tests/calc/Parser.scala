  ...
  private val lexer: Dfa[Token] = {
    lazy val s0: Dfa.State[Token] =
      Dfa.State(
        id = 0,
        transitions = Map(
          0x9.toChar -> Some(Lazy(s5)), // '\t'
          0xA.toChar -> Some(Lazy(s12)), // '\n'
          0x20.toChar -> Some(Lazy(s5)), // ' '
          0x28.toChar -> Some(Lazy(s12)), // '('
          0x29.toChar -> Some(Lazy(s12)), // ')'
          0x2A.toChar -> Some(Lazy(s3)), // '*'
          0x2B.toChar -> Some(Lazy(s11)), // '+'
          ...
          0x3D.toChar -> Some(Lazy(s12)), // '='
          0x5E.toChar -> Some(Lazy(s8)), // '^'
          0x5F.toChar -> Some(Lazy(s13)), // '_'
          0x61.toChar -> Some(Lazy(s13)), // 'a'
          0x62.toChar -> Some(Lazy(s13)), // 'b'
          0x63.toChar -> Some(Lazy(s13)), // 'c'
          0x64.toChar -> Some(Lazy(s13)), // 'd'
          0x65.toChar -> Some(Lazy(s13)), // 'e'
          0x66.toChar -> Some(Lazy(s13)), // 'f'
          0x67.toChar -> Some(Lazy(s13)), // 'g'
          0x68.toChar -> Some(Lazy(s13)), // 'h'
          0x69.toChar -> Some(Lazy(s13)), // 'i'
          0x6A.toChar -> Some(Lazy(s13)), // 'j'
          0x6B.toChar -> Some(Lazy(s13)), // 'k'
          0x6C.toChar -> Some(Lazy(s13)), // 'l'
          0x6D.toChar -> Some(Lazy(s13)), // 'm'
          0x6E.toChar -> Some(Lazy(s13)), // 'n'
          0x6F.toChar -> Some(Lazy(s13)), // 'o'
          0x70.toChar -> Some(Lazy(s13)), // 'p'
          0x71.toChar -> Some(Lazy(s13)), // 'q'
          0x72.toChar -> Some(Lazy(s13)), // 'r'
          0x73.toChar -> Some(Lazy(s13)), // 's'
          0x74.toChar -> Some(Lazy(s13)), // 't'
          0x75.toChar -> Some(Lazy(s13)), // 'u'
          0x76.toChar -> Some(Lazy(s13)), // 'v'
          0x77.toChar -> Some(Lazy(s13)), // 'w'
          0x78.toChar -> Some(Lazy(s13)), // 'x'
          0x79.toChar -> Some(Lazy(s13)), // 'y'
          0x7A.toChar -> Some(Lazy(s13)), // 'z'
        ),
        elseTransition = None,
        yields = None,
      )
    ...
    lazy val s6: Dfa.State[Token] =
      Dfa.State(
        id = 6,
        transitions = Map(
          0x30.toChar -> Some(Lazy(s6)), // '0'
          0x31.toChar -> Some(Lazy(s6)), // '1'
          0x32.toChar -> Some(Lazy(s6)), // '2'
          0x33.toChar -> Some(Lazy(s6)), // '3'
          0x34.toChar -> Some(Lazy(s6)), // '4'
          0x35.toChar -> Some(Lazy(s6)), // '5'
          0x36.toChar -> Some(Lazy(s6)), // '6'
          0x37.toChar -> Some(Lazy(s6)), // '7'
          0x38.toChar -> Some(Lazy(s6)), // '8'
          0x39.toChar -> Some(Lazy(s6)), // '9'
        ),
        elseTransition = None,
        yields = Some(
          Dfa.State.Yields(s0)(
    ...
    lazy val s13: Dfa.State[Token] =
      Dfa.State(
        id = 13,
        transitions = Map(
          0x30.toChar -> Some(Lazy(s13)), // '0'
          0x31.toChar -> Some(Lazy(s13)), // '1'
          0x32.toChar -> Some(Lazy(s13)), // '2'
          0x33.toChar -> Some(Lazy(s13)), // '3'
          0x34.toChar -> Some(Lazy(s13)), // '4'
          0x35.toChar -> Some(Lazy(s13)), // '5'
          0x36.toChar -> Some(Lazy(s13)), // '6'
          0x37.toChar -> Some(Lazy(s13)), // '7'
          0x38.toChar -> Some(Lazy(s13)), // '8'
          0x39.toChar -> Some(Lazy(s13)), // '9'
          0x41.toChar -> Some(Lazy(s13)), // 'A'
          0x42.toChar -> Some(Lazy(s13)), // 'B'
          0x43.toChar -> Some(Lazy(s13)), // 'C'
          0x44.toChar -> Some(Lazy(s13)), // 'D'
          0x45.toChar -> Some(Lazy(s13)), // 'E'
          0x46.toChar -> Some(Lazy(s13)), // 'F'
          0x47.toChar -> Some(Lazy(s13)), // 'G'
          0x48.toChar -> Some(Lazy(s13)), // 'H'
          0x49.toChar -> Some(Lazy(s13)), // 'I'
          0x4A.toChar -> Some(Lazy(s13)), // 'J'
          0x4B.toChar -> Some(Lazy(s13)), // 'K'
          0x4C.toChar -> Some(Lazy(s13)), // 'L'
          0x4D.toChar -> Some(Lazy(s13)), // 'M'
          0x4E.toChar -> Some(Lazy(s13)), // 'N'
          0x4F.toChar -> Some(Lazy(s13)), // 'O'
          0x50.toChar -> Some(Lazy(s13)), // 'P'
          0x51.toChar -> Some(Lazy(s13)), // 'Q'
          0x52.toChar -> Some(Lazy(s13)), // 'R'
          0x53.toChar -> Some(Lazy(s13)), // 'S'
          0x54.toChar -> Some(Lazy(s13)), // 'T'
          0x55.toChar -> Some(Lazy(s13)), // 'U'
          0x56.toChar -> Some(Lazy(s13)), // 'V'
          0x57.toChar -> Some(Lazy(s13)), // 'W'
          0x58.toChar -> Some(Lazy(s13)), // 'X'
          0x59.toChar -> Some(Lazy(s13)), // 'Y'
          0x5A.toChar -> Some(Lazy(s13)), // 'Z'
          0x5F.toChar -> Some(Lazy(s13)), // '_'
          0x61.toChar -> Some(Lazy(s13)), // 'a'
          0x62.toChar -> Some(Lazy(s13)), // 'b'
          0x63.toChar -> Some(Lazy(s13)), // 'c'

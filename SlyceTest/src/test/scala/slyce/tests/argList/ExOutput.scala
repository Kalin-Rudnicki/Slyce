...
object ExOutput extends App {
  ...
  val stateMachine: Builder[Token, NonTerminal, NonTerminal.List]#StateMachine =
    Builder
      .builder[Token, NonTerminal, NonTerminal.List]
      .build { builder =>
        ...
        lazy val s6: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(-\/(_3: Token.__.`)`)) :: elem(\/-(_2: NonTerminal.AnonList1)) :: stateElem(
                      state,
                      -\/(_1: Token.__.`(`),
                    ) :: stackT =>
                  (
        ...
        lazy val s10: builder.State =
          builder.State(
            ...
            returnFs = List(
              {
                case elem(\/-(_3: NonTerminal.AnonList1_2)) :: elem(-\/(_2: Token._var)) :: stateElem(
                      state,
                      -\/(_1: Token.__.`,`),
                    ) :: stackT =>
                  (
